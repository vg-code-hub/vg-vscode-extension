export default {
  swagger2api: [
    {
      path: '/Users/dongdongzhao/.vgcode/materials/materials/swagger2api/common',
      name: 'common',
      script:
    ...
    {
      path: '/Users/dongdongzhao/.vgcode/materials/materials/swagger2api/dart/base_http',
      name: 'base_http',
      script: '',
      config: {},
      model: {},
    ...
    {
      path: '/Users/dongdongzhao/.vgcode/materials/materials/swagger2api/dart/model',
      name: 'model',
      script:
        "module.exports = {\n\tbeforeCompile: (context) => {\n\t\tcontext.outputChannel.appendLine(Object.keys(context))\n\t\tcontext.vscode.window.showErrorMessage('12134')\n\t\treturn { a: 'lowcode' }\n\t},\n\tafterCompile: (constext) => {\n\t\tcontext.outputChannel.appendLine(Object.keys(context))\n\t},\n}\n",
      config: {},
      ...
      preview: {},
      template:
        'class <%= className %> {\n  <%- properties %>\n  <%= className %>(<%- constructorContent %>);\n\n  factory <%= className %>.fromJson(Map<String, dynamic> json) => <%= className %>(\n    <%- fromJsonContent %>\n  );\n\n  Map<String, dynamic> toJson() => {\n    <%- toJsonContent %>\n  };\n}',
    },
    {
      path: '/Users/dongdongzhao/.vgcode/materials/materials/swagger2api/dart/request',
      name: 'request',
      script:
  ...
  schema2code: [
    {
      path: '/Users/dongdongzhao/.vgcode/materials/materials/schema2code2/dart-create-controller',
      name: 'dart-create-controller',
      model: {},
      schema: {},
      preview: {
        title: '',
    ...
    {
      path: '/Users/dongdongzhao/.vgcode/materials/materials/schema2code2/dart-create-page',
      name: 'dart-create-page',
      model: {},
      schema: {},
      preview: {
        title: '',
    ...
    {
      path: '/Users/dongdongzhao/.vgcode/materials/materials/schema2code2/dart-detail-controller',
      name: 'dart-detail-controller',
      model: {},
      schema: {},
      preview: {
        title: '',
    ...
    {
      path: '/Users/dongdongzhao/.vgcode/materials/materials/schema2code2/dart-detail-page',
      name: 'dart-detail-page',
      model: {},
      schema: {},
      preview: {
        title: '',
    ...
    {
      path: '/Users/dongdongzhao/.vgcode/materials/materials/schema2code2/dart-list-controller',
      name: 'dart-list-controller',
      model: {},
      schema: {},
      preview: {
        title: '',
    ...
    {
      path: '/Users/dongdongzhao/.vgcode/materials/materials/schema2code2/dart-list-item',
      name: 'dart-list-item',
      model: {},
      schema: {},
      preview: {
    ...
    {
      path: '/Users/dongdongzhao/.vgcode/materials/materials/schema2code2/dart-list-page',
      name: 'dart-list-page',
      model: {},
      schema: {},
      preview: {
