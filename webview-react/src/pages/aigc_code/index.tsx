...
const SnippetsPage: React.FC = () => {
  ...
  useMount(async () => {
    ...
    for (let obj of payload) {
      ...
      total_res += obj.payload.choices.text.reduce(
  ...
  class TTSRecorder {
    ...
    onWillStatusChange:
      | ((oldStatus: string, newStatus: string) => void)
      | undefined;
    ...
    result(resultData: string) {
      ...
      total_res =
        total_res +
        jsonData.payload.choices.text.reduce(
          (pre: any, cur: any) => pre + cur.content,
          '',
        );
      setOutputText(total_res);
  ...
  return (
    <PageContainer ghost>
      ...
      <TextArea value={outputText} autoSize={{ minRows: 3, maxRows: 20 }} />
    </PageContainer>
  );
};
