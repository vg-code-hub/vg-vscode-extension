 ...
 * @LastEditors: zdd
 * @LastEditTime: 2023-05-31 14:58:44
 * @FilePath: /vg-vscode-extension/src/provider/jump-to-definition.ts
 * @Description: 
 */
/**
...
export function jumpToDefinition(context: vscode.ExtensionContext) {
    // 注册如何实现跳转到定义，第一个参数表示仅对json文件生效
    context.subscriptions.push(vscode.languages.registerDefinitionProvider([{ pattern: '**/package.json' }, 'javascript'], {
        provideDefinition
    }));
};